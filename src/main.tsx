...
function MainCover() {
  return <div className='absolute w-full h-full flex flex-row'>
    <div className='absolute h-full right-0 w-[10%] bg-white flex flex-col'>
      <div className='h-[54%] w-full bg-black flex flex-col'>
        ...
        <p className='text-white rotate-90 mt-[1vh] text-nowrap' style={{ fontFamily: 'Playstation', fontSize: '5vh', letterSpacing: '0.2vh' }}>Grrrnd Zero</p>
      </div>
      <div className='h-full w-full'>
        <p className='text-black rotate-90 mt-[3vh] text-nowrap' style={{ fontFamily: 'Playstation', fontSize: '5vh', letterSpacing: '0.2vh' }}>20 ans du Grrrnd Zero</p>
    ...
    <div className='absolute z-50 top-[63vh] left-[40vh] flex justify-center items-center ' style={{ transform: 'rotate(-3deg)', width: '22vh', backgroundImage: 'url(./Stamp2.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', aspectRatio: '1.77', filter: "drop-shadow(0px 0px 5px rgba(0, 0, 0, 0.5))" }}>
      <div className='text-white text-center' style={{ fontSize: '2.5vh', fontFamily: 'Bangers', letterSpacing: '0.3vw', fontWeight: 'bold' }}>
        Release
        <br />
        party
      </div>
    ...
    <div className='absolute bottom-[2vh] left-[2vh] flex flex-col bg-white w-[27vh]'>
    ...
    <div className='absolute bottom-[2vh] left-[31vh] flex flex-col bg-white w-[15vh]'>
      <div className='uppercase font-normal  border-solid bg-black px-[0.5vh] text-white border-[0.2vh] border-black' style={{ fontSize: "2vh", fontFamily: 'Roboto' }}>
        Visuels
      </div>
    ...
    <div className='absolute flex flex-col left-[2vw] top-[14.8vh] stroke-black stroke-2' style={{ transform: 'rotate(-5deg)' }}>
      <div className='' style={{
        fontSize: '18vh', fontWeight: 'bold', color: 'white',
        WebkitTextStrokeWidth: "0.1vh", WebkitTextStrokeColor: "black", fontFamily: 'Bangers', filter: 'drop-shadow(0.5vh 0.5vh 0 black)'
      }}>
        Kate NV
      </div>
      <div className='text-black absolute left-[10vw] top-[21vh]' style={{
        letterSpacing: '0.1vw', fontSize: '3vh', fontWeight: 'bold', width: '45vw',
      ...
      <div className='absolute top-[15vh] right-[-14vw] ' style={{
        letterSpacing: '0.3vw', fontSize: '3vh', fontWeight: 'normal',
    ...
    <div className='absolute flex flex-col left-[23vw] top-[43.5vh] stroke-black stroke-2'>
      <div className='' style={{
        color: 'white', fontSize: '6vh', fontWeight: 'bold', filter: 'drop-shadow(0.25vh 0.25vh 0 black)',
        WebkitTextStrokeWidth: "0.1vh", WebkitTextStrokeColor: "black", fontFamily: 'Bangers'
      }}>
        Lametia
      </div>
      <div className='absolute text-black top-[7vh] left-[-2vw]' style={{
        letterSpacing: '0.1vw', fontSize: '3vh', fontWeight: 'bold', width: '85vw',
      ...
      <div className='absolute top-[2.5vh] right-[-5vw]' style={{
        letterSpacing: '0.3vw', color: 'black', fontSize: '3vh', fontWeight: 'normal',
        WebkitTextStrokeWidth: "0.1vh", WebkitTextStrokeColor: "white", fontFamily: 'Bangers', filter: 'drop-shadow(0.25vh 0.25vh 0 white)'
      }}>
        IT
      </div>
    ...
    <div className='absolute flex flex-col left-[20vw] top-[55vh] stroke-black stroke-2'>
      ...
      <div className='absolute text-black top-[7vh] left-[-5vw]' style={{
        letterSpacing: '0.1vw', fontSize: '3vh', fontWeight: 'bold',
        WebkitTextStrokeWidth: "0.1vh", WebkitTextStrokeColor: "white", filter: 'drop-shadow(0.25vh 0.25vh 0 white)'
      }}>
        synth pop cheloue
      </div>
      <div className='absolute top-[2.5vh] right-[-11.5vw] text-black ' style={{
        letterSpacing: '0.3vw', color: 'black', fontSize: '3vh', fontWeight: 'normal',
        WebkitTextStrokeWidth: "0.1vh", WebkitTextStrokeColor: "white", fontFamily: 'Bangers', filter: 'drop-shadow(0.25vh 0.25vh 0 white)'
      }}>
        Dijon
    ...
    <div className='absolute flex flex-col left-[17vw] top-[68vh] stroke-black stroke-2'>
      ...
      <div className='absolute top-[11.5vh] left-[-7vw] text-black ' style={{
        letterSpacing: '0.1vw', fontSize: '3vh', fontWeight: 'bold',
      ...
      <div className='absolute top-[6vh] right-[-10vw] text-black ' style={{
        letterSpacing: '0.3vw', color: 'black', fontSize: '3vh', fontWeight: 'normal',
        WebkitTextStrokeWidth: "0.1vh", WebkitTextStrokeColor: "white", fontFamily: 'Bangers', filter: 'drop-shadow(0.25vh 0.25vh 0 white)'
      }}>
        Lyon
